...
def compute_cost(joint_angles , target_position , target_rotation, weight_position, weight_rotation, precomputed):
    ...
    error_rotation_1 = np.linalg.norm(euler_angles1[:3] - target_rotation[:3])
...
if __name__ == "__main__":
    ...
    n_guesses = 50 # Number of random initial guesses for the optimization
